...
HD_PWD='C:/Users/Enoch/Git/Digital-Design-Learning/ram_single_port_sync_read/ram_single_port_sync_read.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_sp_sync_read.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_sp_sync_read.tcl
